...
function generarReporteBiblioteca($biblioteca) {
    ...
    $autorConteo = array_count_values(array_column($biblioteca, 'autor'));
    arsort($autorConteo);
    $autorConMasLibros = key($autorConteo);
    $cantidadAutorConMasLibros = current($autorConteo);
    ...
    return [
        ...
        'autor_con_mas_libros' => [
            ...
            'cantidad' => $cantidadAutorConMasLibros
        ]
    ];
}
