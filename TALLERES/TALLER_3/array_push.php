...
$misAmigos = ["Damiano", "Luis", "John"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Leandro", "Ana"); // Reemplaza las comillas vacías con los nombres de tus amigos
