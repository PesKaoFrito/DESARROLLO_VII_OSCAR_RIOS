...
$miFrase = "Aprender PHP es divertido porque PHP permite crear aplicaciones dinámicas y, gracias a la comunidad de PHP, siempre encuentras soluciones rápidas."; // Reemplaza esto con tu frase
