...
$misComidas = ["Arroz frito", "Pizza", "Sushi"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Tacos", "Ensalada", "Pasta"]; // Reemplaza con las comidas favoritas de tu amigo
